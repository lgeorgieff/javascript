...
// Description: Illustrates how to write into a writable stream and how to use the cork/uncork methods.
// ====================================================================================================================
...
// Call cork(9, so that all data is buffered until uncork() or end() is called.
destination.cork();
...
// Since we called cork on the stream flushed will never evaluate to true and drain will never be fired.
// To motivate the stream writing the internal buffer ito the abstracted source we need to call either uncork() or end().
setTimeout(function () {
    destination.uncork();
}, 3000);
