/**
 * @fileoverview Illustrates how to annotate classes as interfaces and how to implement them.
...
/**
 * The interface <tt>Vehicle</tt> is thought to be the base type for all forms of vehicles.
 * @public
 * @interface
 */
function Vehicle () { }
...
/**
 * A getter indicating whether the {@link Vehicle} is moving or not.
 *
 * @public
 *
 * @type {boolean}
